...
void vgui::Scheme::setColor(vgui::Scheme *const this, vgui::Scheme::SchemeColor sc, int r, int g, int b, int a)
{
  *(__m128i *)&this->_color[sc][0] = _mm_unpacklo_epi64(
                                       _mm_move_epi64(_mm_unpacklo_epi32(_mm_cvtsi32_si128(r), _mm_cvtsi32_si128(g))),
                                       _mm_move_epi64(_mm_unpacklo_epi32(_mm_cvtsi32_si128(b), _mm_cvtsi32_si128(a))));
}

void vgui::Scheme::getColor(vgui::Scheme *const this, vgui::Scheme::SchemeColor sc, int *const r, int *const g, int *const b, int *const a)
{
  int *v6; // eax

  v6 = (int *)((char *)this + 16 * sc);
  *r = v6[1];
  *g = v6[2];
  *b = v6[3];
  *a = v6[4];
...
void vgui::Scheme::setFont(vgui::Scheme *const this, vgui::Scheme::SchemeFont sf_0, vgui::Font *font)
{
  if ( font )
    this->_font[sf_0] = font;
}

void vgui::Scheme::setCursor(vgui::Scheme *const this, vgui::Scheme::SchemeCursor scu, vgui::Cursor *cursor)
{
  if ( cursor )
    this->_cursor[scu] = cursor;
}

void vgui::Scheme::Scheme(vgui::Scheme *const this)
{
  vgui::Font *v1; // esi
  vgui::Font *v2; // esi
  vgui::Font *v3; // esi
