...
void vgui::Font::getTextSize(const char *text, int *const wide, int *const tall)
{
  ...
  *tall = 0;
  if (text)
  {
    *tall = (*((int(__cdecl **)(vgui::Font *const))_vptr_Font + 4))(this);
    v5 = *text;
    if (*text)
    {
      v6 = 0;
      do
      {
        while (v5 == 10)
        {
          ++v4;
          v9 = *tall;
          v7 = (*((int(__cdecl **)(vgui::Font *const))_vptr_Font + 4))(this);
          v6 = 0;
          *tall = v9 + v7;
          v5 = *v4;
          if (!*v4)
        ...
        v8 = v6;
        (*((void(__cdecl **)(vgui::Font *const, _DWORD, int *, int *, int *))_vptr_Font + 2))(
            this,
            v5,
            &a,
            &b,
...
{
  return (*((int(__cdecl **)(vgui::BaseFontPlat *))_plat->_vptr_BaseFontPlat + 6))(_plat);
}

void vgui::Font::getCharRGBA(int ch, int rgbaX, int rgbaY, int rgbaWide, int rgbaTall, uchar *rgba)
{
  (*((void(__cdecl **)(vgui::BaseFontPlat *))_plat->_vptr_BaseFontPlat + 3))(_plat);
}

void vgui::Font::getCharABCwide(int ch, int *const a, int *const b, int *const c)
{
  (*((void(__cdecl **)(vgui::BaseFontPlat *))_plat->_vptr_BaseFontPlat + 4))(_plat);
}

int vgui::Font::getTall()
{
  return (*((int(__cdecl **)(vgui::BaseFontPlat *))_plat->_vptr_BaseFontPlat + 5))(_plat);
}
...
void vgui::Font::init(const char *name, void *pFileData, int fileDataLen, int tall, int wide, float rotation, int weight, bool italic, bool underline, bool strikeout, bool symbol)
{
  ...
  else
  {
    ...
    if (v16 <= 0)
      goto LABEL_13;
    while (!(*((uint8_t(__cdecl **)(vgui::BaseFontPlat *, const char *, int, int, _DWORD, int, bool, bool, bool, bool))staticFontPlatDar._data[v17]->_vptr_BaseFontPlat + 2))(
